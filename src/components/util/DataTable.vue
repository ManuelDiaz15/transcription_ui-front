        ...
        <v-card>
            ...
            <v-card-text>
                <v-container>
                    <v-row>
                        <v-col cols="12">
                            <v-text-field label="Nombre" required v-model="nameElement">
                            <v-textarea>
                            </v-textarea>
                            </v-text-field>
                        </v-col>
                        <v-col cols="12">
                            <v-text-field label="Número" required v-model="numberElement">
                            >
            ...
            <v-spacer></v-spacer>
                ...
                <v-btn color="#26c6da" text :disabled= "isLoading" @click="aggregateItem()">
                    Guardar
                </v-btn>
            </v-card-actions>
        </v-card>
...
@Component({
    ...
    export default class DataTable extends Vue{
        ...
        public edit_number = "";
        public current_item = {'name': '', 'number': ''}; 
    mounted(): void {
        this.getData();
    }
    ...
    private getData() {
        ...
        let config = {
				method: 'get',
				url: 'http://localhost:9090/model1',
